 ...
 * the Tango device.
 */
public class AugmentedRealityRenderer extends RajawaliRenderer implements OnObjectPickedListener {
    ...
    protected void initScene() {
        ...
        bob = new RayPicker(this);
        bob.setOnObjectPickedListener(this);
...
//        }
    ...
    public void onObjectPicked(Object3D object) {
        if (object != null) {
            Log.e("###### FOOBAR", "onObjectPicked: Object NOT null: " + object.getClass().getSimpleName());
        } else {
            Log.e("###### FOOBAR", "onObjectPicked: Object IS null");
        }
